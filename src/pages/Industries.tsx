...
const industries = [
  ...
  },
  {
    ...
    challenges: ['Biocontainment for live attenuated viral organisms', 'Aseptic fill-finish operations with ISO 5 requirements', 'Cold chain facility design for -20°C and -80°C storage', 'WHO prequalification compliance documentation'],
  ...
  },
  {
    ...
    desc: 'ISO 13485-aligned cleanroom and facility engineering for sterile and non-sterile medical device manufacturing.',
    challenges: ['ISO 14644 cleanroom classification for device manufacturing', 'EtO sterilization facility design and validation', 'Particulate contamination control in assembly areas', 'ISO 13485 quality system integration'],
    solutions: ['ISO Class 7/8 cleanroom design for device assembly', 'EtO sterilization chamber engineering and validation', 'HVAC with enhanced particle monitoring', 'ISO 13485 facility documentation support'],
    ...
    <div>
      ...
      <section className="page-hero">
        ...
        <div className="max-w-7xl mx-auto px-6" style={{ position: 'relative', zIndex: 1 }}>
          <div className="section-label mb-5">Industries We Serve</div>
